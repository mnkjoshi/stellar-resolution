import{DZ as Pe,DW as ve,Er as be,BR as _,Da as w,D$ as De,BS as H,BP as r,cY as j,BH as te,DY as Ee,CR as A,tz as we,hx as v,ed as ie,au as h,dT as R,eg as F,Es as Ve,ky as ne,D8 as se,Cr as T,eh as b,Et as ae,aS as re,aT as le,ef as xe,ec as Se,ll as ye,jD as Le,eB as Ce,dS as Ae,av as oe,BT as ce,BU as he,_ as de,BG as Te,bd as G,et as z,DX as Me,pt as $e,bh as Re,Cp as Ue,Dk as Oe,az as o,BO as X,aA as Ie,at as O,lt as qe,cG as pe,aO as N,tr as ze,g9 as Ne,tf as je,tg as Be,Eu as We,r as g,C9 as x,E3 as He,E4 as k,Ev as Fe,Ew as Ge,pU as Xe,E5 as c,Ex as U,Ey as ke,DU as Y,ev as Ye,ew as Ze,ri as Je,ey as Ke,ez as Qe,eA as et,m as M,b as tt,Ez as it,bf as Z}from"./index-BCRx-hwS.js";import{t as nt}from"./VisualElement-C7VHkPsy.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(ve),n.include(be),n.uniforms.add(new _("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new _("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new _("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new _("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>{var s;return(s=i.depth)==null?void 0:s.attachment}),new H("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const B=j(6);function fe(t){const e=new te;e.include(Ee),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new _("maxPixelDistance",(i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const i=(a,l,d)=>v(a,l.heightManifoldTarget,d.camera.viewMatrix),s=(a,l)=>v(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new A("heightManifoldOrigin",(a,l)=>(i(f,a,l),s(V,l),ie(V,V,f),R(u,V),u[3]=F(V),u)),new Ve("globalOrigin",a=>s(f,a)),new _("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ne(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
